<html>
    <head>
        <title>Create Students Multi Training By Type PDF Report</title>
    ...
    <body>
        ...
        <div class="docBody"><br/>        
            <h4>Create Students Multi Training By Type PDF Report</h4>
            <br/>
            
            <form name="searchForm" id="searchForm" action="/sdc/PDFReport?overlap&report=studentOver2" method="post">
