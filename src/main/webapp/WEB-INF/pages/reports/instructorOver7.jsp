<html>
    <head>
        <title>Create Training and Testing over 10 hours PDF Report</title>
		...
		<script type="text/javascript" src="/sdc/common/sdc.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="docBody"><br/>        
            <h4>Create Training and Testing over 10 hours PDF Report</h4>
            <br/>
            
            <form name="searchForm" id="searchForm" action="/sdc/PDFReport?overlap&report=instructorOver7" method="post"> 
