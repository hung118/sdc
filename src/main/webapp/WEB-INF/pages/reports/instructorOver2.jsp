<html>
    <head>
        <title>Create Instructor Multi Training By Type PDF Report</title>
    ...
    <body>
        ...
        <div class="docBody"><br/>        
            <h4>Create Instructor Multi Training By Type PDF Report</h4>
            <br/>
            
            <form name="searchForm" id="searchForm" action="/sdc/PDFReport?overlap&report=instructorOver2" method="post">
