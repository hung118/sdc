<html>
    <head>
        <title>Create Students Multi Training PDF Report</title>
    ...
    <body>
        ...
        <div class="docBody"><br/>        
            <h4>Create Students Multi Training PDF Report</h4>
            
            <form name="searchForm" id="searchForm" action="/sdc/PDFReport?overlap&report=studentOver1" method="post">
