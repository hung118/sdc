...
<html>
    <head>
        <title>Create Vehicle Training Overlap PDF Report</title>
    ...
    <body>
        ...
        <div class="docBody"><br/>        
            <h4>Create Vehicle Training Overlap PDF Report</h4>
            <br/>
            
            <form name="searchForm" id="searchForm" action="/sdc/PDFReport?overlap&report=vehicleOver1" method="post"> 
