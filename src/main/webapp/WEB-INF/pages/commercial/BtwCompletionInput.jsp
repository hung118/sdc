...
<html>
    ...
    <body>
        ...
        <div id="commercialForm" style="display:block;">
            <s:form namespace="/commercial" action="insertBtwCompletion">
                <s:token />
                <tr>
                    <td colspan="2">
                            ...
                            <tr>
                                <td class="standardcell" style="text-align:center;">
                                    <table>
                                        ...
                                        <s:textfield value="%{btwCompletionDateFormat}" name="btwCompletionDate" id="btwCompletionDate" cssClass="datepicker" maxlength="10"/>
                                    </table>
                                </td>
                            </tr>
                        </table>
