...
<html>
    ...
    <body>
        ...
        <div id="commercialForm" style="display:block;">
            <s:form namespace="/commercial" action="insertClassroomCompletion">
                <s:token />
                <tr>
                    <td colspan="2">
                            ...
                            <tr>
                                <td class="standardcell" style="text-align:center;">
                                    <table>
                                        ...
                                        <s:textfield value="%{trainingCompletionDateFormat}" name="trainingCompletionDate" id="trainingCompletionDate" cssClass="datepicker" maxlength="10"/>
                                    </table>
                                </td>
                            </tr>
                        </table>
